...
const ResetPassword:React.FC = () => {
    ...
    // This route the page to login section after a successful request for resetting password 
    const onSuccess = () => {
        router.push('/auth') 
    }
    ...
    return(
            <div className="container sm:px-10 login">
                ...
                {showStatus && ApiStateHandler(isPending, isError, error, apiStatusHandler, isSuccess, data)}
                <ToastContainer />
            </div>
    )
}
