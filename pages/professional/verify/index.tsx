...
const VerifyLicense = () => {
    ...
    const fetchLicense = async (data:any) => {
        try {
            ...
            setLoading(false);
            toast.error("User doesn't exit, please contact admin", {
            ...
            <center className="md:hidden"><img alt="Dental Board of Nigeria"  src={process.env.NEXT_PUBLIC_URL+'/dist/images/dental_logo.png'} /></center>
                ...
                <div className={`${!checked == true ? 
                   ...
                   {!checked ?
                    ...
                    <>
                        <div >
                            <center><img className="text-center mt-10" src={license.license.status == "Valid" ? 
                                process.env.NEXT_PUBLIC_URL+"/dist/images/valid_icon.png" : 
                                process.env.NEXT_PUBLIC_URL+"/dist/images/expired.png"} 
                                width="30%"  /></center>
                        </div>
                    ...
                    <div className="flex flex-col lg:flex-row border-b">
                        <div className="flex flex-1 px-5 items-center justify-center lg:justify-start">
                            ...
                            <div className="ml-5">
                                <div className="  truncate sm:whitespace-normal font-medium text-lg">{license?.license.prof?.last_name}
                                    {license?.license.prof?.first_name} {license?.license.prof?.middle_name}</div>
                    ...
                    <div className="mt-6 lg:mt-0 px-5 border-l border-r dark:border-darkmode-400 border-t lg:border-t-0 pt-5 lg:pt-0" style={{width:"100%"}}> 
                            ...
                            <div className="flex flex-col lg:items-start mt-4">
                                ...
                                <div className="truncate sm:whitespace-normal flex  font-medium text-lg  mt-3">License Validity: <span style={{ color: license && 
                                    license.license.status === "Valid" ? "green" : "red", paddingLeft: "5px" }}>{license?.license.status == "Valid" ?
                                    "License Up-To-Date" : "License Expired"}</span></div>
                            </div>
                    </div>
