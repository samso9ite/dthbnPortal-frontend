        ...
        <>
         ...
         <div className="col-span-12 mt-6">
            <div className="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                <h2 className="text-lg font-medium truncate mr-5"> Receipts </h2>
                 <button className="btn btn-primary" style={{backgroundColor: '#280742'}} onClick={() => setIsModalOpen(true)}>Upload New  Receipt </button>
